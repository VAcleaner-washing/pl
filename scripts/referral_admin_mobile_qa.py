...
<div class="referral-action-panel"><div><small>Надіслати програму</small><strong>Оберіть канал</strong><span>Текст скопіюється автоматично. Після відправки підтвердьте її в адмінці.</span></div><div class="referral-primary-actions"><button class="btn primary">Надіслати в Instagram</button><button class="btn">Надіслати в Telegram</button><button class="btn">Скопіювати текст</button></div></div>
