...
<div class="referral-share-card referral-code-card"><div><span>Код клієнта</span><strong>VA-A1B2C3D</strong><small>Друг −100 грн · клієнт −150 грн після завершення оренди друга</small></div><button class="btn referral-copy-code">Скопіювати код</button></div>
<div class="referral-share-stats referral-share-stats-4"><span><small>Надсилань</small><b>4</b></span><span><small>Рекомендацій</small><b>3</b></span><span><small>Зароблено</small><b>450 грн</b></span><span><small>Доступно</small><b>300 грн</b></span></div>
<div class="referral-action-panel"><div><small>Надіслати програму</small><strong>Основний канал · Instagram</strong></div><div class="referral-primary-actions"><button class="btn primary">Instagram · надіслати</button><button class="btn">Telegram · надіслати</button><button class="btn">Скопіювати текст</button></div></div>
...
<details class="referral-message-details"><summary><span>Текст повідомлення</span><small>Розгорнути</small></summary><div class="referral-message-preview">Дякуємо, що обираєте VAcleaner 🤍<br><br>Приведіть друга — бонус отримають обоє.</div></details>
