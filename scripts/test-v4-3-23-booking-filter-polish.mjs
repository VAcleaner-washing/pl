...
const prev=html.indexOf('/assets/admin-v4322.css?v=4322');
const next=html.indexOf('/assets/admin-v4323.css?v=4323');
...
ok(sw.includes('/assets/admin-v4323.css?v=4323'),'service worker precaches v4.3.23 CSS');
...
ok(!css.includes('display:none!important')||!css.includes('.chip b{display:none'),'counts are not hidden by the presentation layer');
