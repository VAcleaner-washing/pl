...
if(!errors.length){
  ...
  const required=['vacleaner-booking-v5','vacleaner-booking-v4','vacleaner-admin-bookings-v3','vacleaner-admin-bookings-v2','vacleaner-admin-bookings','vacleaner-settings','vacleaner-push','vacleaner-admin-data-v1','vacleaner-campaigns-v1'];
  ...
  const bookingV5=bySlug.get('vacleaner-booking-v5'),adminData=bySlug.get('vacleaner-admin-data-v1'),campaignApi=bySlug.get('vacleaner-campaigns-v1');
