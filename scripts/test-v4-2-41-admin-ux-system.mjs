...
const baseCss=fs.readFileSync('assets/admin-v250.css','utf8');
...
const checks=[
  ...
  ['wide desktop period controls cannot shrink or wrap',baseCss.includes('.analytics-toolbar .analytics-period-controls{flex:0 0 auto}')&&baseCss.includes('.finance-period-row .analytics-periods{flex-wrap:nowrap}')],
