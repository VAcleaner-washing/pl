...
ok('public loads address helper',pub.includes('/assets/address-autocomplete.js?v=4135')&&pub.includes('/assets/address-autocomplete.css?v=4135'));
ok('admin loads address helper',admin.includes('/assets/address-autocomplete.js?v=4135')&&admin.includes('/assets/address-autocomplete.css?v=4135'));
...
ok('delivery details are separate',runtime.includes('Під’їзд / квартира / поверх')&&runtime.includes('DETAILS_SEPARATOR'));
