...
ok('public loads address helper',pub.includes('/assets/address-autocomplete.js?v=4136')&&pub.includes('/assets/address-autocomplete.css?v=4136'));
ok('admin loads address helper',admin.includes('/assets/address-autocomplete.js?v=4136')&&admin.includes('/assets/address-autocomplete.css?v=4136'));
