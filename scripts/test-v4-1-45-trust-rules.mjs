...
ok('public summary has tiered copy',publicSlots.includes('Полтава, Розсошенці, Щербані та Горбанівка')&&publicSlots.includes('тариф підтвердить менеджер'));
...
ok('delivery page publishes both tariffs',delivery.includes('Розсошенці')&&delivery.includes('350 грн'));
