...
const checks=[
 ...
 ['city delivery uses both cars and exposes their average',js.includes("consumptionL100:11")&&js.includes("consumptionL100:10")&&js.includes('carRows=cars.map')&&js.includes('Середня між двома авто')],
