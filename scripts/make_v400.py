...
'''<p class="v4-lead">Пляма — це не завжди задача «потерти сильніше». Найчастіше результат залежить від того, чи не втерли забруднення глибше ще до основного очищення.</p><h2>1. Не розтирайте пляму по площі</h2><p>Якщо забруднення свіже, спочатку промокніть надлишок чистою серветкою або мікрофіброю. Рухайтесь від країв до центру.</p><h2>2. Зрозумійте, що це за пляма</h2><p>Для звичайних або невідомих локальних плям у VAcleaner використовується VA SPOT FIX 50 мл. Для старих кольорових слідів від кави, чаю, вина, ягід або соків — VA STAIN OX 30 мл. Якщо потрібні обидва засоби, їх застосовують окремо з промиванням між етапами. Перед першим застосуванням обов’язково перевіряють стійкість барвника на непомітній ділянці.</p><h2>3. Плямовивідник — не заміна промиванню</h2><p>Після локального засобу оброблену ділянку потрібно промити чистою водою або миючим пилососом. Для диванів і крісел цю роль виконує Kärcher Puzzi.</p><h2>4. Якщо є ще й запах</h2><p>Пляма й запах — дві різні задачі. Якщо мова про запах сечі, у VAcleaner пріоритетний нейтралізатор — Neutralix; його не варто підміняти звичайним ароматизатором.</p>'''),
...
'''<p class="v4-lead">У матраца після дитини часто дві окремі проблеми: видима пляма та запах. Якщо працювати лише з однією, результат може бути неповним.</p><h2>1. Почніть із сухого етапу</h2><p>Перед вологим очищенням приберіть пил, волосся й дрібне сухе сміття. Якщо пилу багато, особливо в матраці, окремий сухий етап помітно спрощує подальше промивання.</p><h2>2. Запах сечі — окрема задача</h2><p>У підборі VAcleaner для запаху сечі Neutralix має пріоритет №1. Його задача — нейтралізація запаху, а не маскування ароматом.</p><h2>3. Якщо лишилась видима пляма</h2><p>Тоді додається VA SPOT FIX 50 мл для локального опрацювання звичайної або невідомої плями. Перед застосуванням перевірте стійкість барвника на непомітній ділянці.</p><h2>4. Завершіть глибоким промиванням</h2><p>Kärcher Puzzi промиває текстиль і відбирає забруднену воду. Після очищення матрацу потрібно дати повністю висохнути з нормальною вентиляцією.</p>''')]
