...
const staticSuites=[
  ...
  'test:v4.2.0-admin-function-freeze','test:v4.2.0-public-architecture','test:v4.2.1-referral','test:v4.2.2-hardening','test:v4.2.5-baseline-compatibility','test:v4.2.7-backend-route-cleanup','test:v4.2.8-recovery','test:v4.2.9-referral-analytics','test:v4.2.10-referral-phone','test:v4.2.11-cache-bust','test:v4.2.12-referral-ux','test:v4.2.13-admin-typography','test:v4.2.14-admin-ops-ux','test:v4.2.15-browser-contracts','test:v4.2.16-finance-truth','test:v4.2.22-admin-truth-ux','test:v4.2.23-system-spec-pwa-guard','test:v4.2.24-finance-delivery-return','test:v4.2.25-admin-qa-repair',
