...
delete baselineConfig.deliveryPricing?.fuel?.cityCars;
const baselineBytes=JSON.stringify(baselineConfig,null,2)+'\n';
ok('canonical v4.1.63 business config remains unchanged outside the additive city-car fuel profiles',crypto.createHash('sha256').update(baselineBytes).digest('hex')==='b012feec312f8334316d7d3a42dd46f0056ba1924919ad7fa6d1b2c875779649');
