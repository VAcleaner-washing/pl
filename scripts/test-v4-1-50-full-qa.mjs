...
ok('booking hardening uses current cache key',booking.includes(`/assets/booking-hardening-v4144.css?v=${rel.build}`)&&booking.includes(`/assets/booking-hardening-v4144.js?v=${rel.build}`)&&((exp.includes(`booking-hardening-v4144.css?v=${rel.build}`))||(bookingRoute.includes("ensureAsset('css','booking-hardening-v4144.css')")&&bookingRoute.includes("const build=new URL(current||location.href,location.href).searchParams.get('v')"))));
