...
const solutionPages={
  textile:{
    ...
    description:'Як глибоко почистити диван і м’які меблі вдома: підготовка, локальні плями, контроль вологи та промивання текстилю Kärcher Puzzi.',
  },
  steam:{
    heading:'Чистіші кухня й ванна без десятка засобів',
    description:'Що можна чистити пароочисником удома: кухня, ванна, плитка та шви, де пара доречна, де потрібна обережність і як працювати з Kärcher SC 2.',
  },
  windows:{
    heading:'Чисті вікна з меншим обсягом ручної роботи',
    description:'Як спростити миття звичайних і панорамних вікон: підготовка скла, безпечний запуск, страхування та робота з роботом ABIR WD8.',
  },
};
...
// v4.2.0 — one canonical full delivery answer across every public FAQ surface.
// Compact badges/footer copy may stay Poltava-only, but a full FAQ answer must
// always disclose the suburb tariff before the customer reaches checkout.
...
apply(fullDeliveryFaqFiles,[
  ['Так. Самовивіз у Полтаві — точне місце отримання менеджер повідомить під час опрацювання заявки. Доставка в межах Полтави — 250 грн за привезення техніки до вас і повернення назад; у заявці потрібно вказати адресу.',canonicalDeliveryFaq],
  ['Так. Полтава, Розсошенці, Щербані та Горбанівка — 250 грн за доставку до вас і повернення техніки назад. Інше передмістя — від 350 грн. За межами робочої зони вартість погоджуємо до передоплати.',canonicalDeliveryFaq],
  ['Так. Доставка по Полтаві до вас і назад коштує 250 грн; також доступний самовивіз.',canonicalDeliveryFaq],
  ['Так. Доставка до вас і назад коштує 250 грн; також доступний самовивіз.',canonicalDeliveryFaq],
  ['Так. Доступні доставка техніки до вас і назад та самовивіз у Полтаві. Актуальну вартість сайт показує під час оформлення.',canonicalDeliveryFaq],
]);
