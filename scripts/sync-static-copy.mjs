...
apply(bookingFiles,[
  ...
  ['Засоби купуються окремо. Якщо додали засіб до бронювання — його вартість одразу входить у замовлення.','Базові порції для Puzzi видаємо окремо й рахуємо після повернення. Нижче — додаткові засоби під конкретні плями, запахи й поверхні; вони купуються окремо й залишаються у вас.'],
  ['Підберіть під конкретне забруднення · засоби купуються окремо й залишаються у вас.','Базові порції для Puzzi видаємо окремо й рахуємо після повернення. Нижче — додаткові засоби під конкретні плями, запахи й поверхні; вони купуються окремо й залишаються у вас.'],
  ['Засоби купуються окремо й залишаються у вас.','Базові порції для Puzzi видаємо окремо й рахуємо після повернення. Нижче — додаткові засоби під конкретні плями, запахи й поверхні; вони купуються окремо й залишаються у вас.'],
