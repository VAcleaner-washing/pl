...
for(const file of walk(root).filter(f=>f.endsWith('.html'))){
  ...
  s=s.replace(/(\/assets\/(?:vacleaner-core|public-experience|public-catalog|public-booking-slots|public-resilience|public-quiz|admin-v250|admin-glass-test|public-fixes|mobile-home-fix|site-v400)\.(?:js|css))\?v=[^"']+/g,`$1?v=${build}`);
