...
def mobile_suite(browser: Browser, qa: QA, width: int, label: str) -> None:
    ...
    try:
        ...
        qa.check('12 SMS · 3 використано' in page.locator('.campaign-main>small').first.inner_text(), f"{label}: SMS campaign result line uses successful SMS recipients instead of generated codes")
