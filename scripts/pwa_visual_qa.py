    ...
    try:
        ...
        for view in ["bookings","calendar", "upcoming", "equipment", "clients", "campaigns", "analytics", "chemistry", "settings"]:
            ...
            if view=='upcoming':
                ...
                qa.check(phone_icon['display']=='flex' and phone_icon['align']=='center' and '📞' in phone_icon['before'], f"{label}: upcoming phone uses the handset icon aligned on the number baseline")
