...
const checks=[
  ...
  [backend.includes('loyalty, promo, pendingPromo'), 'customer lookup returns the active phone promo'],
  [admin.includes("action:'lookup_customer',phone,productCode:form.productCode.value"), 'admin new-booking lookup validates promo against current product/dates'],
