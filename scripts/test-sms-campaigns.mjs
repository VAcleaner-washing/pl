...
check(campaign.includes('waitForSendpulseAddressBook')&&campaign.includes('active_phones_quantity')&&campaign.includes('new_phones_quantity'),'personalized SMS waits until SendPulse activates newly imported phones before preflight/send');
check(campaign.includes('sendpulse_addressbook_not_ready')&&campaign.includes('sendpulse_addressbook_rejected'),'address-book activation failures surface precise diagnostics instead of No active phones race');
