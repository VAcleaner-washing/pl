...
if(!publicExperienceCss.includes('.package-page-grid .package-card-large{')||!publicExperienceCss.includes('grid-template-rows:')||!publicExperienceCss.includes('.package-page-grid .package-card-large .package-purpose{min-height:82px}')||!publicExperienceCss.includes('.package-page-grid .package-card-large ul{min-height:146px;align-content:start}'))errors.push('Desktop package cards must use shared vertical zones so all public package rows stay aligned');
