...
ok('navigator still strips access details',admin.includes('function deliveryAddressParts(value)')&&admin.includes('const address=deliveryAddressParts(value).address')&&admin.includes('navigationDestination(value)'));
