...
ok(html.includes('/assets/admin-v4326.css?v=4326'),'admin loads v4.3.26 CSS');
ok(/vacleaner-manager-(4326|4300)/.test(sw),'service-worker cache follows source or stamped namespace');
ok(sw.includes('/assets/admin-v4326.css?v=4326'),'service worker precaches v4.3.26 CSS');
