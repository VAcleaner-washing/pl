...
has(admin,'Середнє пальне між Passat CC і Fiesta','delivery analytics must expose the average between the two cars');
has(admin,"if(!routeKm)return[]",'booking fuel estimate must refuse missing route distance');
has(admin,'До клієнта: визначаємо дорожню відстань','missing route distance must be explicit and actionable');
