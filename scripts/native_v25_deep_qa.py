...
def boot(browser,w=390,h=844):
 ...
 p.evaluate("html=>{document.body.innerHTML=html;document.documentElement.classList.add('glass-test','native-test','native-v2','native-v21','native-v22','native-v23','native-v24','native-v25')}",INITIAL);p.evaluate(base.init_script(True,True))
...
with sync_playwright() as pw:
 ...
 b.close()
print(f'NATIVE V2.5 DEEP QA: PASS {passed} · FAIL {len(failed)}')
if failed:
