const CACHE='vacleaner-manager-29130';
const CORE=['/admin/bronuvannia/','/assets/admin-v250.css?v=2.9.13.0','/assets/admin-v250.js?v=2.9.13.0','/admin/manifest.webmanifest','/icon-192.png','/icon-512.png'];
