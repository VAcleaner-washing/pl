const CACHE='vacleaner-manager-3000';
const CORE=['/admin/bronuvannia/','/assets/vacleaner-core.js?v=3000','/assets/admin-v250.css?v=3000','/assets/admin-v250.js?v=3000','/admin/manifest.webmanifest','/icon-192.png','/icon-512.png'];
