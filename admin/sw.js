const CACHE='vacleaner-manager-v29120';
const CORE=['/admin/bronuvannia/','/assets/admin-v250.css?v=2.9.12.0','/assets/admin-v250.js?v=2.9.12.0','/admin/manifest.webmanifest','/icon-192.png','/icon-512.png'];
