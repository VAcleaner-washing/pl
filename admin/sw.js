const CACHE='vacleaner-manager-4140';
const FALLBACK='/admin/bronuvannia/';
const CORE=[FALLBACK,'/assets/vacleaner-core.js?v=4140','/assets/admin-v250.css?v=4140','/assets/admin-v250.js?v=4140','/assets/admin-glass-test.css?v=4140','/assets/admin-glass-test.js?v=4140','/admin/manifest.webmanifest','/admin/icon-192.png','/admin/icon-512.png','/admin/apple-touch-icon.png?v=4140'];
