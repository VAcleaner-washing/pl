const CACHE='vacleaner-manager-4245';
const FALLBACK='/admin/bronuvannia/';
const CORE=[FALLBACK,'/assets/vacleaner-core.js?v=4245','/assets/admin-v250.css?v=4245','/assets/admin-v250.js?v=4245','/assets/admin-glass-test.css?v=4245','/assets/admin-glass-test.js?v=4245','/admin/manifest.webmanifest','/admin/icon-192.png','/admin/icon-512.png','/admin/apple-touch-icon.png?v=4245'];
