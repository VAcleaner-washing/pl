const CACHE='vacleaner-manager-4054';
const FALLBACK='/admin/bronuvannia/';
const CORE=[FALLBACK,'/assets/vacleaner-core.js?v=4054','/assets/admin-v250.css?v=4054','/assets/admin-v250.js?v=4054','/assets/admin-glass-test.css?v=4054','/assets/admin-glass-test.js?v=4054','/admin/manifest.webmanifest','/icon-192.png','/icon-512.png','/apple-touch-icon.png?v=4054'];
