# VAcleaner v3.0.81 — PUSH DEVICE CONTROL + FAVICON
...
- Existing active subscriptions reduced to the two newest iPhone registrations; each phone will acquire a stable device id after opening v3.0.81.
