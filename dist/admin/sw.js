const CACHE='vacleaner-manager-3020';
const FALLBACK='/admin/bronuvannia/';
const CORE=[FALLBACK,'/assets/vacleaner-core.js?v=3020','/assets/admin-v250.css?v=3020','/assets/admin-v250.js?v=3020','/admin/manifest.webmanifest','/icon-192.png','/icon-512.png','/apple-touch-icon.png'];
