const CACHE='vacleaner-manager-3005';
const CORE=['/admin/bronuvannia/','/assets/vacleaner-core.js?v=3005','/assets/admin-v250.css?v=3005','/assets/admin-v250.js?v=3005','/admin/manifest.webmanifest','/icon-192.png','/icon-512.png'];
