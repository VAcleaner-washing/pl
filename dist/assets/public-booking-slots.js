...
function normalizeDeliveryPricing(raw={}){
  ...
  return{
    ...
    fuel:{petrolPerL:Number(fuelSrc.petrolPerL)||83,lpgPerL:Number(fuelSrc.lpgPerL)||45,consumptionL100:Number(fuelSrc.consumptionL100)||7,tripMultiplier:Number(fuelSrc.tripMultiplier)||4}
  };
}
