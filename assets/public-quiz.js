(()=>{
  ...
  const PRODUCT_INFO={
    ...
    puzzi_jimmy:{label:'Глибоке очищення текстилю',price:1050,desc:'Puzzi + Jimmy · сухий етап проти пилу, пилових кліщів і пов’язаних алергенів перед глибоким промиванням матраців та м’яких меблів.'},
