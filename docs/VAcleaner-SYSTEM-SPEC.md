...
- On desktop widths above 1320 px, the shared Finance/Analytics period selector no longer shrinks inside the Analytics toolbar or wraps its fifth option onto a second line.
...
- `npm run test:admin-control-consistency` (width, relative X/Y, container size, single-row desktop geometry and visual-state parity across 390 / 430 / 1024 / 1280 / 1440 px);
- `npm run qa:static`;
