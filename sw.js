const CACHE='vacleaner-manager-v2400';
const CORE=['/admin/bronuvannia/','/assets/admin-v240.css?v=2400','/assets/admin-v240.js?v=2400','/manifest.webmanifest','/icon-192.png','/icon-512.png'];
