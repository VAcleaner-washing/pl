const CACHE='vacleaner-manager-v29110';
const CORE=['/admin/bronuvannia/','/assets/admin-v250.css?v=2.9.11.0','/assets/admin-v250.js?v=2.9.11.0','/manifest.webmanifest','/icon-192.png','/icon-512.png'];
