const CACHE='vacleaner-manager-v2990';
const CORE=['/admin/bronuvannia/','/assets/admin-v250.css?v=2.9.9.0','/assets/admin-v250.js?v=2.9.9.0','/manifest.webmanifest','/icon-192.png','/icon-512.png'];
