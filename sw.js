const CACHE='vacleaner-manager-v2420';
const CORE=['/admin/bronuvannia/','/assets/admin-v240.css?v=2401','/assets/admin-v240.js?v=2401','/manifest.webmanifest','/icon-192.png','/icon-512.png'];
