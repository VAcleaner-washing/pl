const CACHE='vacleaner-manager-v2440';
const CORE=['/admin/bronuvannia/','/assets/admin-v240.css?v=2440','/assets/admin-v240.js?v=2440','/manifest.webmanifest','/icon-192.png','/icon-512.png'];
